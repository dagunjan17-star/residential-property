...
export default function BlogDetails({ post }) {
  ...
  return (
    <div className="max-w-6xl mx-auto gap-10 px-4 py-12
      ...
      <article className="space-y-12">
        ...
        <div className="w-full flex justify-center pt-2">
          <div className="w-full">
            ...
            shadow-sm border border-[#F75270]/10">
              <Image
            ...
            <div className="mt-16">
              ...
              <div className="space-y-5 max-w-4xl mx-auto">
                ...
                {single.FAQs.map((faq, i) => (
                  <details
                    key={i}
                    className="group bg-white border border-[#F75270]/10 rounded-xl p-5 
                    shadow-sm hover:shadow-md transition duration-300"
                  >

                    <summary className="flex justify-between items-center cursor-pointer list-none">

                      <span className="font-semibold text-gray-900 group-hover:text-[#F75270] transition">
                        {faq.Q}
                      </span>

                      <span className="ml-4 text-[#F75270] transition-transform duration-300 group-open:rotate-180">
                        ▼
                      </span>
                    </summary>

                    <div className="mt-3 text-gray-600 leading-relaxed border-t border-[#F75270]/10 pt-3">
                      {faq.A}
                    </div>
